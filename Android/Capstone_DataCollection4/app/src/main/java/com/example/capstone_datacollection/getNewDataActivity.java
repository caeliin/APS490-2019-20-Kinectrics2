...
public class getNewDataActivity extends AppCompatActivity {
    ...
    private void connectedUI() {
        ...
        if(get10min == null){
            get10min = new Button(this);
            get10min.setText("Current 10mins");
            get10min.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    get10minGraph();
                }
            });
            get10min.setBackgroundResource(R.drawable.bottom_border);
            myLayout.addView(get10min);
        }
    ...
    public void get10minGraph(){
        ...
        try{
            ...
            int day = Integer.parseInt(currentTime.substring(0,2));
            int month = Integer.parseInt(currentTime.substring(3,5));
            int year = Integer.parseInt(currentTime.substring(6,10));
            int hour = Integer.parseInt(currentTime.substring(11,13));
            int min = Integer.parseInt(currentTime.substring(14,16));
            int sec = Integer.parseInt(currentTime.substring(17,19));

            Log.d("day:",String.valueOf(day)+String.valueOf(month)+String.valueOf(year)+String.valueOf(hour)+String.valueOf(min)+String.valueOf(sec));
            ...
            mBluetoothService.queryTime(year, month,day,hour,min,sec);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_READ:
                    ...
                    Log.d("messageDump","ReadMessgae: "+readMessage);
                    break;
                case MESSAGE_TOAST:
